...
public class Actuality4_12 {
	...
	public static void reservation() {
		...
		if(abs==1) {
			...
			else { System.out.println("번호 1~10자리 중에서 선택해주세요"); }
		}
		else if(abs==2) {
			System.out.print("A>>");
			aseat.print();
		...
		else { System.out.println("좌석 1,2,3번 중 골라주세요"); }
	}
	...
	public static void cancel() {
		...
		else { System.out.println("좌석 1,2,3번 중에서 골라주세요."); }
	}
